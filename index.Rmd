...
I chose this chart because it represents both what people had scored on both the Academic Efficiency and Cynical MBI with the the gender that they identify with. The chart allows people to see if there is any relatioinship or correlation between the topics. As there is many stigmas against women in STEM careers regarding their intellect, it is interesting to see how they score on the academic effciency MBI score compared to their male collegues. By also including the cynical score, we are able to see if there is any correlation between the two different MBI tests.
...
I chose this chart because it helps to gain a visual understanding of what ages study the most. It's important to see how study hours affects students, and when comparing bachelors degrees to masters and phd students ages of students differ. From personal experience, I've seen and heard how first year college students struggle the most, especially because they are so young. I wanted to make a chart to show the correlation between age and study hours to further analyze how study hours may be decreased with age, and use that to then analyze mental health. 
